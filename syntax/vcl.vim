...
syn match   vclVariable		"\v<(resp\.body|resp\.do_esi|resp\.http\.[a-zA-Z0-9_-]+|resp\.is_streaming|resp\.proto|resp\.reason|resp\.status|resp)>" contained
