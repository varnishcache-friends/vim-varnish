...
call s:check('#t:sub_vcl_init', 'vcl_init', 'vclSubroutine', 'vcl_init subroutine')
call s:check('#t:sub_vcl_recv', 'vcl_recv', 'vclSubroutine', 'vcl_recv subroutine')
call s:check('#t:sub_vcl_builtin_recv', 'vcl_builtin_recv', 'vclSubroutine', 'vcl_builtin_recv hook')
call s:check('#t:sub_vcl_req_url', 'vcl_req_url', 'vclSubroutine', 'vcl_req_url hook')
call s:check('#t:sub_vcl_unknown', 'vcl_foo', '', 'unknown vcl_foo is not a builtin subroutine')
call s:check('#t:sub_pre40_fetch', 'vcl_fetch', '', 'pre-Varnish-4 vcl_fetch is not highlighted')
call s:check('#t:sub_pre40_error', 'vcl_error', '', 'pre-Varnish-4 vcl_error is not highlighted')
call s:check('#t:sub_pre40_log', 'vcl_log', '', 'pre-Varnish-4 vcl_log is not highlighted')
